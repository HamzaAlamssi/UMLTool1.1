...
public class MessageService {
        ...
        public Message sendMessage(String senderId, Long projectId, String content) {
                logger.info("Attempting to send message: senderId={}, projectId={}, content={}", senderId, projectId,
                                content);
                ...
                Message message = Message.builder()
                                ...
                                .project(project)
                                .content(content)
                                .timestamp(Instant.now().atZone(ZoneId.of("Asia/Amman")).toInstant()) // Use UTC+03:00
                                                                                                      // (Amman)
                                .build();
                logger.info("Message successfully created: sender={}, projectId={}, timestamp={}", sender.getEmail(),
                                projectId, message.getTimestamp());
